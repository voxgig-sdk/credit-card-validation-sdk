...
This API verifies the validity and authenticity of credit card details provided by users.

Learn more about Credit Card Validation API at [arielservices.ct.ws](https://arielservices.ct.ws).

This is an unofficial SDK for the Credit Card Validation public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Validation — that you
...
- Upstream API: [https://arielservices.ct.ws/stripe.php?cc=](https://arielservices.ct.ws/stripe.php?cc=)
