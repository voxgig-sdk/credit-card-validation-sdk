...
// instead of `sdk.NewCreditCardValidationSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *CreditCardValidationSDK  { return NewCreditCardValidationSDK(nil) }
func Test() *CreditCardValidationSDK { return TestSDK(nil, nil) }
