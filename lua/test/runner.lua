...
function runner.env_override(m)
  local live = runner.getenv("CREDIT_CARD_VALIDATION_TEST_LIVE")
  local override = runner.getenv("CREDIT_CARD_VALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CREDIT_CARD_VALIDATION_TEST_EXPLAIN")
