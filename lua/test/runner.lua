...
function runner.env_override(m)
  local live = runner.getenv("CREDITCARDVALIDATION_TEST_LIVE")
  local override = runner.getenv("CREDITCARDVALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CREDITCARDVALIDATION_TEST_EXPLAIN")
