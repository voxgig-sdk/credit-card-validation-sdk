...
describe("ValidationDirect", function()
  it("should direct-load-validation", function()
    local setup = validation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-validation", setup.live and "live" or "unit")
