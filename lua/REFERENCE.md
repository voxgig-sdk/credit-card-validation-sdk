# CreditCardValidation Lua SDK Reference

Complete API reference for the CreditCardValidation Lua SDK.
...
```lua
local result, err = client:Validation(nil):load({ id = "validation_id" }, nil)
```
