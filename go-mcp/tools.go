...
type Args struct {
	Entity string         `json:"entity" jsonschema:"validation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CreditCardValidationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "credit-card-validation_list",
		Description: "List records from CreditCardValidation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "credit-card-validation_load",
		Description: "Load a single record from CreditCardValidation. " +
...
func runOp(client *sdk.CreditCardValidationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CreditCardValidationSDK, name string) (sdk.CreditCardValidationEntity, error) {
