// Command CreditCardValidation-mcp is an MCP server exposing the CreditCardValidation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CreditCardValidation_list  — list records of an entity
//	CreditCardValidation_load  — load a single record of an entity
//
