...
// CreditCardValidation SDK utility type

class CreditCardValidationUtility
{
    ...
    public static function copy(CreditCardValidationUtility $src): CreditCardValidationUtility
    {
        $u = new CreditCardValidationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
