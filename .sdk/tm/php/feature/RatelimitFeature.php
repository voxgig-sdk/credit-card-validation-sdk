...
// CreditCardValidation SDK ratelimit feature
...
class CreditCardValidationRatelimitFeature extends CreditCardValidationBaseFeature
{
    ...
    private function _acquire(CreditCardValidationContext $ctx): void
    {
    ...
    private function _track(CreditCardValidationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
