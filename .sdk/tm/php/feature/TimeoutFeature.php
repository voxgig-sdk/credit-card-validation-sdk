...
// CreditCardValidation SDK timeout feature
...
class CreditCardValidationTimeoutFeature extends CreditCardValidationBaseFeature
{
    ...
    private function _with_timeout(CreditCardValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CreditCardValidationContext $_ctx, float $ms): void
    {
        $client = $this->client;
