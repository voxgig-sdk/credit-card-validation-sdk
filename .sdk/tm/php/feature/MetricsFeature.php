...
// CreditCardValidation SDK metrics feature
...
class CreditCardValidationMetricsFeature extends CreditCardValidationBaseFeature
{
    ...
    private function _record(CreditCardValidationContext $ctx, bool $ok): void
    {
