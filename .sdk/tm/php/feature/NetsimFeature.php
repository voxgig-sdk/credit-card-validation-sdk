...
// CreditCardValidation SDK netsim feature
...
class CreditCardValidationNetsimFeature extends CreditCardValidationBaseFeature
{
    ...
    private function _simulate(CreditCardValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CreditCardValidationContext $ctx, array $applied): void
    {
        $client = $this->client;
