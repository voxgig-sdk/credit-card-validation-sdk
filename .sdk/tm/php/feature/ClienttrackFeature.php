...
// CreditCardValidation SDK clienttrack feature
...
class CreditCardValidationClienttrackFeature extends CreditCardValidationBaseFeature
{
    ...
    public function PostConstruct(CreditCardValidationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CreditCardValidation-SDK';
