...
// CreditCardValidation SDK rbac feature
...
class CreditCardValidationRbacFeature extends CreditCardValidationBaseFeature
{
    ...
    private function _required(CreditCardValidationContext $ctx): ?string
    {
    ...
    private function _reject(CreditCardValidationContext $ctx, string $required): void
    {
    ...
    private function _track(CreditCardValidationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
