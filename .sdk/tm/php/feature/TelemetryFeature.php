...
// CreditCardValidation SDK telemetry feature
...
class CreditCardValidationTelemetryFeature extends CreditCardValidationBaseFeature
{
    ...
    private function _close(CreditCardValidationContext $ctx, bool $ok): void
    {
