...
// CreditCardValidation SDK utility: result_basic

class CreditCardValidationResultBasic
{
    public static function call(CreditCardValidationContext $ctx): ?CreditCardValidationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof CreditCardValidationError) ? $result->err->msg : (string)$result->err;
