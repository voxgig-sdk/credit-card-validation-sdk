...
class CreditCardValidationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CreditCardValidationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CreditCardValidationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CreditCardValidationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
