# CreditCardValidation SDK feature corpus test
#
...
def _client(kase):
    ...
    CreditCardValidationSDK(...), not CreditCardValidationSDK.test(...): the `test` feature is
    ...
    return CreditCardValidationSDK(opts)
