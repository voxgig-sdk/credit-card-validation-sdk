...
from projectname_sdk.core.control import CreditCardValidationControl
...
class CreditCardValidationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CreditCardValidationControl()
        ...
        if isinstance(sp, CreditCardValidationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CreditCardValidationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CreditCardValidationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CreditCardValidationError(code, msg, self)
