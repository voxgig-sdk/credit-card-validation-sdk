...
// CreditCardValidation SDK audit feature
...
class CreditCardValidationAuditFeature extends CreditCardValidationBaseFeature
{
    ...
    private function _emit(CreditCardValidationContext $ctx, string $outcome): void
    {
