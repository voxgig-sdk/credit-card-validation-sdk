...
// CreditCardValidation SDK proxy feature
...
class CreditCardValidationProxyFeature extends CreditCardValidationBaseFeature
{
    ...
    public function init(CreditCardValidationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CreditCardValidationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
