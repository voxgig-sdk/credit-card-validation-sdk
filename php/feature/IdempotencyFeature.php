...
// CreditCardValidation SDK idempotency feature
...
class CreditCardValidationIdempotencyFeature extends CreditCardValidationBaseFeature
{
    ...
    private function _mutating(CreditCardValidationContext $ctx): bool
    {
