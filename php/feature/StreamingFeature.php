...
// CreditCardValidation SDK streaming feature
...
class CreditCardValidationStreamingFeature extends CreditCardValidationBaseFeature
{
    ...
    private function _iterate(CreditCardValidationResult $result): \Generator
    {
    ...
    private function _streamable(CreditCardValidationContext $ctx): bool
    {
