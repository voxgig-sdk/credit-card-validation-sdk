...
// CreditCardValidation SDK pipeline test
//
...
{
    private static function utility(): CreditCardValidationUtility
    {
        return new CreditCardValidationUtility();
    }
    ...
    private static function ctx(array $over = []): CreditCardValidationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CreditCardValidationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CreditCardValidationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CreditCardValidationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CreditCardValidationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CreditCardValidationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CreditCardValidationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CreditCardValidationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CreditCardValidationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CreditCardValidationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CreditCardValidationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CreditCardValidationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CreditCardValidationResponse([]),
            'result' => new CreditCardValidationResult([]),
        ]);
        [, $err] = CreditCardValidationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CreditCardValidationSpec([]),
            'response' => null,
            'result' => new CreditCardValidationResult([]),
        ]);
        [, $err] = CreditCardValidationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CreditCardValidationSpec(['step' => 's']),
            'response' => new CreditCardValidationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CreditCardValidationResult([]),
        ]);
        [, $err] = CreditCardValidationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CreditCardValidationSpec(['step' => 's']),
            'response' => new CreditCardValidationResponse(self::resp(200, ['v' => 1])),
            'result' => new CreditCardValidationResult([]),
        ]);
        [, $err] = CreditCardValidationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CreditCardValidationSpec(['step' => 's']),
            'response' => new CreditCardValidationResponse(self::resp(200, ['v' => 2])),
            'result' => new CreditCardValidationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CreditCardValidationMakeResponse::call($ctx);
    ...
    {
        $preset = new CreditCardValidationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CreditCardValidationSpec([]),
            'response' => new CreditCardValidationResponse([]),
            'result' => new CreditCardValidationResult([]),
        ...
        [$got, $err] = CreditCardValidationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CreditCardValidationResult([])]);
        [, $err] = CreditCardValidationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CreditCardValidationSpec([]), 'result' => null]);
        [, $err] = CreditCardValidationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CreditCardValidationSpec(['step' => 's']),
            'result' => new CreditCardValidationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CreditCardValidationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CreditCardValidationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CreditCardValidationSpec(['step' => 's']),
            'result' => new CreditCardValidationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CreditCardValidationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CreditCardValidationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CreditCardValidationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CreditCardValidationSpec([]),
            'result' => new CreditCardValidationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CreditCardValidationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CreditCardValidationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CreditCardValidationError('boom', 'boom');
        $utility->fetcher = function (CreditCardValidationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CreditCardValidationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CreditCardValidationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CreditCardValidationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CreditCardValidationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CreditCardValidationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CreditCardValidationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CreditCardValidationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CreditCardValidationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CreditCardValidationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CreditCardValidationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CreditCardValidationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CreditCardValidationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CreditCardValidationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CreditCardValidationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CreditCardValidationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CreditCardValidationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CreditCardValidationResult(['ok' => false])]);
        $this->expectException(CreditCardValidationError::class);
        CreditCardValidationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CreditCardValidationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CreditCardValidationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CreditCardValidationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CreditCardValidationBaseFeature();
        $b = new CreditCardValidationBaseFeature();
        CreditCardValidationFeatureAdd::call($ctx, $a);
        CreditCardValidationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CreditCardValidationBaseFeature
    {
        $f = new CreditCardValidationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CreditCardValidationFeatureAdd::call($ctx, self::named_feature('a'));
        CreditCardValidationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        CreditCardValidationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        CreditCardValidationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        CreditCardValidationFeatureAdd::call($ctx, $replace);
        ...
        CreditCardValidationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CreditCardValidationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CreditCardValidationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CreditCardValidationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CreditCardValidationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CreditCardValidationResponse(['headers' => null]),
            'result' => new CreditCardValidationResult([]),
        ]);
        CreditCardValidationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CreditCardValidationResultBody::call($ctx);
