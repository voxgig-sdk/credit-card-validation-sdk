...
{
    public function test_direct_load_validation(): void
    {
        $setup = validation_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-validation", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
