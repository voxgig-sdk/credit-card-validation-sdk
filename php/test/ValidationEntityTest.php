...
class ValidationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CREDITCARDVALIDATION_TEST_VALIDATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function validation_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CREDITCARDVALIDATION_TEST_VALIDATION_ENTID");
