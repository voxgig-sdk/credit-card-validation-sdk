...
// CreditCardValidation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CreditCardValidationSDK::test)
...
{
    private const SDK_CLASS = 'CreditCardValidationSDK';
    ...
    private const SDK_BASE = 'creditcardvalidation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../creditcardvalidation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
