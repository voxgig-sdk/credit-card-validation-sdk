# CreditCardValidation PHP SDK Reference

Complete API reference for the CreditCardValidation PHP SDK.
...
#### `CreditCardValidationSDK::test($testopts = null, $sdkopts = null)`
