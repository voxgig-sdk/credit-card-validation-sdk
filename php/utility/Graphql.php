...
// CreditCardValidation SDK utility: graphql
//
...
class CreditCardValidationGraphql
{
    ...
    // equivalent.
    public static function body(CreditCardValidationContext $ctx): mixed
    {
    ...
    public static function errors(CreditCardValidationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
