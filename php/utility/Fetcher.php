...
// CreditCardValidation SDK utility: fetcher

class CreditCardValidationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CreditCardValidationSDK/1.0)';
    ...
    public static function call(CreditCardValidationContext $ctx, string $fullurl, array $fetchdef): array
    {
