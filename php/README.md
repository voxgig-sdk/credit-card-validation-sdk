# CreditCardValidation PHP SDK



The PHP SDK for the CreditCardValidation API — an entity-oriented client using PHP conventions.
...
```
php/
├── creditcardvalidation_sdk.php          -- Main SDK class
...
The main class (`creditcardvalidation_sdk.php`) exports the SDK class
