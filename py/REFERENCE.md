# CreditCardValidation Python SDK Reference

Complete API reference for the CreditCardValidation Python SDK.
...
#### `CreditCardValidationSDK.test(testopts=None, sdkopts=None)`
...
| --- | --- | --- | --- |
| `cardNumber` | `str` | No | Masked credit card number |
| `cardType` | `str` | No | Type of credit card (Visa, MasterCard, American Express, etc.) |
...
| `message` | `str` | No | Additional information or error message |
...
```python
result = client.Validation().load({"cc": "cc"})
```
