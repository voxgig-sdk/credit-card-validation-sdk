# CreditCardValidation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CreditCardValidationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CreditCardValidationSDK(...) and CreditCardValidationSDK.test(...) become
#      CreditCardValidationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "creditcardvalidation_sdk"
_SDK_CLASS = "CreditCardValidationSDK"
