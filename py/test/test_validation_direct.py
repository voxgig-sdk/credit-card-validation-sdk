...
class TestValidationDirect:
    ...
    def test_should_direct_load_validation(self):
        setup = _validation_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-validation", "live" if setup["live"] else "unit")
        if _skip:
