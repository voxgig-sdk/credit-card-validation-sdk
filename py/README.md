# CreditCardValidation Python SDK



The Python SDK for the CreditCardValidation API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Validation()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/credit-card-validation-sdk/releases)) or
...
| --- | --- | --- |
| `cardNumber` | `str` | Masked credit card number |
| `cardType` | `str` | Type of credit card (Visa, MasterCard, American Express, etc.) |
...
```
py/
├── creditcardvalidation_sdk.py         -- Main SDK module
