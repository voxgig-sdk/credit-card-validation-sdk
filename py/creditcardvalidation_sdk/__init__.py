...
from creditcardvalidation_sdk.utility import register

# Load features
from creditcardvalidation_sdk.feature.base_feature import CreditCardValidationBaseFeature
from creditcardvalidation_sdk.features import _has_feature, _make_feature
...
class CreditCardValidationSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CreditCardValidationUtility()
        self._utility = utility

        from creditcardvalidation_sdk.config import shared_config
    ...
    def get_utility(self):
        return CreditCardValidationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CreditCardValidationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Validation(self, data=None) -> "ValidationEntity":
        ...
        from creditcardvalidation_sdk.entity.validation_entity import ValidationEntity
        return ValidationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "CreditCardValidationSDK":
        if sdkopts is None:
            sdkopts = {}
