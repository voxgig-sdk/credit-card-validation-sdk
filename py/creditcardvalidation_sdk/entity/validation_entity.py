...
from creditcardvalidation_sdk.creditcardvalidation_types import (
    Validation,
    ValidationLoadMatch,
)
...
class ValidationEntity:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Validation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Validation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
