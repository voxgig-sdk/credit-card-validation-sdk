...
#      offline in seeded test mode (CreditCardValidationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CreditCardValidation_sdk.rb")
  SDK_CLASS = "CreditCardValidationSDK"
  ...
  SDK_BASE = "CreditCardValidation_sdk"
