# CreditCardValidation Ruby SDK Reference

Complete API reference for the CreditCardValidation Ruby SDK.
...
#### `CreditCardValidationSDK.test(testopts = nil, sdkopts = nil)`
