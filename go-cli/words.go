...
func registerSDKWords(r *eng.Registry, client *sdk.CreditCardValidationSDK) {
...
func runOp(client *sdk.CreditCardValidationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
