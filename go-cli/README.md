...
AQL-driven CLI and REPL for the CreditCardValidation SDK. Positional arguments are
...
```sh
go build -o credit-card-validation-cli ./...
```
...
./credit-card-validation-cli list validation
./credit-card-validation-cli load 1 validation
./credit-card-validation-cli load '{id:1}' validation
